...
function App() {
    ...
    socket.onmessage = (e) => {
      ...
      if (parsed.sender == "System") {
        ...
        if (parsed.message === "init") {
          setUserId(parsed.yourUserId);
          userIdRef.current = parsed.yourUserId;
        }

        if (parsed.message == "join" && parsed.userId != userIdRef.current) {
          setMessages((prev) => [
            ...prev,
            {
              id: uuidv4(),
        ...
        if (parsed.message == "leave" && parsed.userId != userIdRef.current) {
          setMessages((prev) => [
            ...prev,
            {
              id: uuidv4(),
        ...
        setMessages((prev) => [
          ...
          {
            id: uuidv4(),
            isOwn: parsed.senderId == userIdRef.current,
  ...
  if (!joined) {
    return (
      <div
        className={`min-h-screen ${darkMode ? "bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900" : "bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50"} flex items-center justify-center p-4`}
      >
        <div
          className={`${darkMode ? "bg-gray-800/80" : "bg-white/80"} backdrop-blur-sm rounded-3xl shadow-2xl p-8 w-full max-w-md border ${darkMode ? "border-gray-700/20" : "border-white/20"}`}
        >
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <Hash
                  className={`absolute left-3 top-1/2 transform -translate-y-1/2 ${darkMode ? "text-gray-500" : "text-gray-400"} w-5 h-5`}
                />
                <input
                  type="text"
                  ref={roomRef}
  ...
  return (
    <div
      className={`h-screen flex flex-col ${darkMode ? "bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900" : "bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50"}`}
    >
      {/* Header */}
      <div
        className={`fixed top-0 w-full z-50 ${darkMode ? "bg-gray-800/80" : "bg-white/80"} backdrop-blur-sm border-b ${darkMode ? "border-gray-700/20" : "border-white/20"} px-6 py-4`}
      >
          ...
          messages.map((msg) => (
            ...
            >
              ...
              >
                ...
                <p
                  className={`text-xs mt-1 ${msg.isOwn ? "text-white/70" : darkMode ? "text-gray-500" : "text-gray-400"}`}
                >
      ...
      {/* Message Input */}
      <div
        className={`fixed bottom-0 w-full z-50 ${darkMode ? "bg-gray-800/80" : "bg-white/80"} backdrop-blur-sm border-t ${darkMode ? "border-gray-700/20" : "border-white/20"} p-6`}
      >
        <div className="flex items-center space-x-4">
          <div className="flex-1 relative">
            ...
            <label
              ...
              className="cursor-pointer absolute left-12 top-1/2 -translate-y-1/2 z-10"
            >
